class GasResistor {
  constructor(_model) {
    ...
    this.type = "resistor"; // type of the model component
    this.subtype = "blood"; // subtype of the model component.
    ...
    this.r_for = 1; // holds the resistance if the flow direction is from comp_from to comp_to
    this.r_for_fac = 1; // holds the factor with which r_for is multiplied
    this.r_back = 1; // holds the resistance if the flow direction is from comp_to to comp_from
    this.r_back_fac = 1; // holds the factor with which r_for is multiplied
    this.r_k = 0; // holds the constant for the non-linear flow dependency of the resistance
    this.r_k_fac = 1; // holds the factor for the constant for the non-linear flow dependency of the resistance
    this.flow = 0;
