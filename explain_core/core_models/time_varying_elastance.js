class TimeVaryingElastance {
  constructor(_model) {
    ...
    this.model_type = "TimeVaryingElastance"; // type of the model component
    ...
    this.el_min = 1; // holds the minimal elastance
    this.el_min_fac = 1.0;
    this.el_max = 1; // holds the maximal elastance
    this.el_max_fac = 1.0;
    this.varying_elastance_factor = 0; // holds the varying elastance factor
...
module.exports = TimeVaryingElastance;
